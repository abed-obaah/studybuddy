...
import programme1 from '../../assets/Science-symbol-2.svg.png'
import programme2 from '../../assets/science-stream-career-options.webp'
import programme3 from '../../assets/maths2.jpg'
import programme4 from '../../assets/colorful-science-education-background_23-2148490697.avif'
import programme5 from '../../assets/math.jpg'
...
const navigation = [
  ...
  { name: 'Category', href: '/Category', icon: UsersIcon, current: true },
    ...
    <>
      ...
      <div className="mx-auto max-w-7xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <div className="sm:flex sm:items-baseline sm:justify-between">
          <h2 className="text-2xl font-bold tracking-tight text-gray-900">Learn by Category</h2>
