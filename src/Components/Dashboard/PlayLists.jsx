...
const navigation = [
  ...
  { name: 'Assignments', href: '/', icon: FolderIcon, current: false },
  { name: 'PlayLists', href: '/PlayLists', icon: CalendarIcon, current: true },
    ...
    <div className="row">
      <div className="column">
        <form action="" method="post" className="save-playlist">
          <button type="submit" className='flex mr-10'>
            <FaRegBookmark className="far fa-bookmark" /> <span>save playlist</span>
          </button>
        </form>
        <div className="thumb">
          <img src={thumb1} alt="" />
